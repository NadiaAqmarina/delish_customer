...
class DikirimDetail extends StatefulWidget {
  const DikirimDetail({Key? key}) : super(key: key);

  @override
  _DikirimDetailState createState() => _DikirimDetailState();
}

class _DikirimDetailState extends State<DikirimDetail> {
  @override
