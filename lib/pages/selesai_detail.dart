...
class SelesaiDetail extends StatefulWidget {
  const SelesaiDetail({Key? key}) : super(key: key);

  @override
  _SelesaiDetailState createState() => _SelesaiDetailState();
}

class _SelesaiDetailState extends State<SelesaiDetail> {
  @override
