...
class DibatalkanDetail extends StatefulWidget {
  const DibatalkanDetail({Key? key}) : super(key: key);

  @override
  _DibatalkanDetailState createState() => _DibatalkanDetailState();
}

class _DibatalkanDetailState extends State<DibatalkanDetail> {
  @override
