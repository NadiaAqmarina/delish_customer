...
class MenungguDetail extends StatefulWidget {
  const MenungguDetail({Key? key}) : super(key: key);

  @override
  _MenungguDetailState createState() => _MenungguDetailState();
}

class _MenungguDetailState extends State<MenungguDetail> {
  @override
